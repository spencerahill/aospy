...
column_energy = Var(
    ...
    vars=[swdn_toa, swup_toa, olr, swup_sfc, swdn_sfc, lwup_sfc, lwdn_sfc, shflx, evap],
    def_time=True,
    def_vert=False,
    def_lat=True,
    def_lon=True,
...
divergence = Var(
    name='divergence',
    domain='atmos',
    description='Horizontal diverence computed from omega and continuity eq.',
    vars=[omega, level, ps],
    def_time=True,
    def_vert=False,
    def_lat=True,
    def_lon=True,
    func=aospy.calcs.divergence,
    units=r's$^{-1}$',
    plot_units=r'10$^{-6}$ s$^{-1}$',
    plot_units_conv=1e6
)
divg_int_max = Var(
    name='divg_int_max',
    domain='atmos',
    description=('Integral of divergence from surface to level that maximizes '
                 'its magnitude'),
    vars=[level, divg],
    def_time=True,
    def_vert=False,
...
dry_static_stab = Var(
    ...
    domain='atmos',
    description='Local upper minus lower level DSE for fixed lower level and varying upper level over all levels.',
    vars=['temp', 'hght', 'level'],
    def_time=True,
    def_vert=True,
    def_lat=True,
    def_lon=True,
...
gms_change_est = Var(
    ...
    vars=[temp, temp, sphum, precip, level],
    def_time=True,
    def_vert=False,
    def_lat=True,
    def_lon=False,
...
gms_h01 = Var(
    ...
    domain='atmos',
    description='Gross moist stability estimated as near surface MSE at ITCZ minus at the local latitude.',
    vars=[temp, hght, sphum, precip, level],
    def_time=True,
    def_vert=False,
    def_lat=True,
    def_lon=False,
...
gross_moist_stab = Var(
    ...
    domain='atmos',
    description='Gross dry stability.',
    vars=[level, divg, temp, hght, sphum],
    def_time=True,
    def_vert=False,
    def_lat=True,
    def_lon=True,
...
moisture_strat = Var(
    ...
    domain='atmos',
    description='',
    vars=['level', 'divg', 'sphum'],
    def_time=True,
    def_vert=False,
    def_lat=True,
    def_lon=True,
    func=aospy.calcs.moisture_strat,
    units='J kg$^{-1}',
    plot_units='Kelvin',
    plot_units_conv=1./c_p
)
...
mass_flux = Var(
    name='mass_flux',
    domain='atmos',
    description='Mass flux: Eulerian meridional mass streamfunction integrated to the level of its maximum magnitude.',
    vars=[lat, level, vcomp],
    def_time=True,
    def_vert=False,
    def_lat=True,
...
vert_centroid = Var(
    name='vert_centroid',
    domain='atmos',
    description='Centroid in the vertical coordinate.',
    vars=[tdt_conv, level],
    def_time=True,
    def_vert=False,
    def_lat=True,
    def_lon=True,
    func=aospy.calcs.vert_centroid,
    units=r'hPa',
    plot_units=r'hPa',
    plot_units_conv=1.
)
...
master_vars_list = [
    ...
    vort, wvp, lat, lon, level, sfc_area, aht, albedo, sfc_albedo, ang_mom,
    bowen_ratio, column_energy, cre_net, cre_lw, cre_sw, descent_tot,
    divergence, divg_int_max, equiv_pot_temp, esf, evap_frac, fmse,
    gms_change_est, gms_change_est2, gms_h01, gms_h01est, gms_h01est2, gms_moc,
    gms_msf, gms_up_low, gms_each_level, gross_dry_stab, gross_moist_stab,
    dry_static_stab, total_gms, dse, moist_static_stab, moisture_strat, mse,
    msf, mass_flux, p_minus_e, pot_temp, prec_conv_frac, qu, qv, sfc_albedo,
    sfc_energy, sfc_lw, sfc_lw_cld, sfc_rad, sfc_rad_cld, sfc_sw, sfc_sw_cld,
    tdt_diab, tdt_lw_cld, tdt_sw_cld, toa_rad, toa_rad_clr, toa_sw,
    toa_swup_cld, vert_centroid, virt_pot_temp
]
