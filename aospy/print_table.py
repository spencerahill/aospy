import cPickle
from aospy import projects, Calc
# from aospy.io import load_plot_data

def print_data(proj, model, exp, ens_mem, var, level,
               intvl, dtype, yr_range, region):
    try:
        d = Calc(proj, model, exp, ens_mem, var, level,
                 intvl, dtype, yr_range, region=region)
